$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bt-css').attr('href', '/bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bt-css').attr('href', '/css/bootstrap-' + themeName + '.min.css');
        }
...
function docReady() {
    ...
    $('#itemReceive-myModal').on('shown.bs.modal', function (e) {

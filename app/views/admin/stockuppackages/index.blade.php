    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> 打包订单</h2>
            </div>
            <div class="box-content" id="order_table">
               	{{ Datatable::table()
    				...
    				->setUrl(route('api.stockuppackageorders'))   // this is the route where data will be retrieved
   					->render() }}
            </div>
        </div>
    </div>
...
$(function() {
  ...
  $('#order_table').on('click', 'button.btn-stockorder', function(){
    $("#order_detail").load("{{ URL::to('admin/stockuppackages/create')}}?order_id="+$(this).data("id"));
  });

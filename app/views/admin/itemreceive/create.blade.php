    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                ...
                <div class="box-icon" data-toggle="tooltip" data-original-title="添加分包录入">
            	<a href="{{URL::to('admin/itemreceive/packagemodal?id='.Input::get('id'))}}" data-target="#itemReceivePackage-myModal" data-toggle="modal"  class="btn btn-round btn-primary btn-lg"><i class="glyphicon glyphicon-plus-sign"></i></a>
                    </div>
            </div>
            <div class="box-content">
             	<h3 class="text-center">预录入收货清单</h3>
               	<!--form-->
